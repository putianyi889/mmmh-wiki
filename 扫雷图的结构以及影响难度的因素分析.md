...
Conclusion: not considering the logical difficulty of a board, the difficulty tends to increase with openings. However, we wish to see an opening when we get stuck while hate to click many times only to get one opening. Life is hard.
