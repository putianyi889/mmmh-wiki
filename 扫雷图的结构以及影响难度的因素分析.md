...
**Conclusion: not considering the logical difficulty of a board, the difficulty tends to increase with openings.** However, when we get stuck, we wish to see an opening for information while when we break through easy parts, we hate to click many times only to get one opening. Life is hard.
