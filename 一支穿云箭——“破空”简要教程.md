...
![](https://github.com/putianyi889/Minesweeper-makes-me-happy/blob/main/wiki/images/icons/uk16.png)Such situations where an opening is revealed by all surrounding information is **too rare to be met by even most experiences players**. So there is not much value to study this case. 
...
![](https://github.com/putianyi889/Minesweeper-makes-me-happy/blob/main/wiki/images/icons/uk16.png)For this single opening, the former strategy wastes 6 clicks, leading to a gap over a second, because this tiny opening.
...
![](https://github.com/putianyi889/Minesweeper-makes-me-happy/blob/main/wiki/images/icons/uk16.png)Opening breaking doesn't care the style you play. Although you can easily solve the midfield openings with flags and chords, everyone needs opening breaking at sides and corners.
...
![](https://github.com/putianyi889/Minesweeper-makes-me-happy/blob/main/wiki/images/icons/uk16.png)Opening breaking stands for around 2% of efficiency and more for NF players and everyone need opening breaking.
...
![](https://github.com/putianyi889/Minesweeper-makes-me-happy/blob/main/wiki/images/icons/uk16.png)This article might not cover everything, but the explicit knowledge here is enough for a player to get sub40.