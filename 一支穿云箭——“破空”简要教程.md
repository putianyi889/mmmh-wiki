...
# ![](https://github.com/putianyi889/Minesweeper-makes-me-happy/blob/main/wiki/images/icons/china.png)非边角位置的大概率破空
![](https://github.com/putianyi889/Minesweeper-makes-me-happy/blob/main/wiki/images/icons/china16.png)如果一个Op不靠边也不靠角，处于图的中腹位置，那么你几乎无法证明它一定是Op，因为没有边界限制范围的话，至少要确定一个3*3的安全区域，单侧判雷是不可能判出这么大空腔的。只有下图的情况可以：

![](https://github.com/putianyi889/Minesweeper-makes-me-happy/blob/main/wiki/images/ZSW-opening-breaking/8.png)

![](https://github.com/putianyi889/Minesweeper-makes-me-happy/blob/main/wiki/images/icons/china16.png)这种两边往中间夹才能判出Op的情况，即使你**见多识广如作者，身经百战如雷帝**，恐怕实战录像里也是没见过这么玩的，没什么判空的价值。

![](https://github.com/putianyi889/Minesweeper-makes-me-happy/blob/main/wiki/images/icons/china16.png)对于非边角位置的破空，其实很简单，一句话就能说清楚：**尽量选择隔开雷的位置开始点即可**。如果操作不便，那就：**尽量往远离雷的方向走**。

![](https://github.com/putianyi889/Minesweeper-makes-me-happy/blob/main/wiki/images/icons/china16.png)1形成的内凹拐角是重中之重。感性上，你也会觉得这种地方十分脆弱。因为雷很稀疏，存在Op的可能性很大，尽管如此也不是百分之百。要破空的话只需要选一个离已知雷有间隔的安全位置（黄格）开始下手就可以了，轻轻地捅破，FL选手可以标雷双击。
...
![](https://github.com/putianyi889/Minesweeper-makes-me-happy/blob/main/wiki/images/icons/china16.png)雷旁边出了1怎么玩，FL选手标雷双击1是最稳妥的，NF玩家可以尝试用左键往远离雷的方向点一下。
...
![](https://github.com/putianyi889/Minesweeper-makes-me-happy/blob/main/wiki/images/icons/china16.png)如果雷排成一列，宛如一堵墙，那么就用垂直于雷墙的点击方向往外走。

![](https://github.com/putianyi889/Minesweeper-makes-me-happy/blob/main/wiki/images/ZSW-opening-breaking/12.gif)

![](https://github.com/putianyi889/Minesweeper-makes-me-happy/blob/main/wiki/images/icons/china16.png)四格里面，当然要先跳过蓝格点那排更远的黄格了（标雷玩家可以尝试标1开4）。

![](https://github.com/putianyi889/Minesweeper-makes-me-happy/blob/main/wiki/images/ZSW-opening-breaking/11.png)

# ![](https://github.com/putianyi889/Minesweeper-makes-me-happy/blob/main/wiki/images/icons/china.png)玄学——加成效应

## ![](https://github.com/putianyi889/Minesweeper-makes-me-happy/blob/main/wiki/images/icons/china.png)靠边加成

![](https://github.com/putianyi889/Minesweeper-makes-me-happy/blob/main/wiki/images/icons/china16.png)在靠边的时候非常容易出Op，对于一个疯狂的破空大佬来说，只要靠边的地方有远离雷的格子可以点，那不要放过，即使跳过去也要点。
...
![](https://github.com/putianyi889/Minesweeper-makes-me-happy/blob/main/wiki/images/icons/china16.png)蓝黄涂色部分均安全，我经常会选隔开雷靠边的黄色格求破空，操作显得比较跳。
...
![](https://github.com/putianyi889/Minesweeper-makes-me-happy/blob/main/wiki/images/icons/china16.png)再比如：
...
![](https://github.com/putianyi889/Minesweeper-makes-me-happy/blob/main/wiki/images/icons/china16.png)如果靠边点出一个1紧邻着雷，你可以确定蓝黄两格都安全，但是我建议你直接点靠边的黄格，破空几率极大（我称之为“掰边”）。此外做好打开Op的心理准备，压住节奏，以图看清新出现的局面。而拉上去点蓝格十分愚蠢，直接暴露玩家没有破空和预判的能力。实例很多，随便找两个：
...
![](https://github.com/putianyi889/Minesweeper-makes-me-happy/blob/main/wiki/images/icons/china16.png)点黄格之前我是做好了很充分的准备的，因此不会被忽然出现的Op打乱节奏，能快速衔接下去。

![](https://github.com/putianyi889/Minesweeper-makes-me-happy/blob/main/wiki/images/icons/china16.png)甚至极端一点的说，只要靠边有一个格子可以点，那就有试一试的价值，不要放过，清干净。

## https://github.com/putianyi889/Minesweeper-makes-me-happy/blob/main/wiki/images/icons/china.png点角王道

![](https://github.com/putianyi889/Minesweeper-makes-me-happy/blob/main/wiki/images/icons/china16.png)只要能判出角可以点，就先点角。不管是不是op，稳赚不亏（其实这个习惯挺难养成）。
...
# ![](https://github.com/putianyi889/Minesweeper-makes-me-happy/blob/main/wiki/images/icons/china.png)破空的重要性

![](https://github.com/putianyi889/Minesweeper-makes-me-happy/blob/main/wiki/images/icons/china16.png)参观一下最弱破空和最强破空的差距。

![](https://github.com/putianyi889/Minesweeper-makes-me-happy/blob/main/wiki/images/icons/china16.png)同样的局部，这个op是很典型的边空，很容易解决。

![](https://github.com/putianyi889/Minesweeper-makes-me-happy/blob/main/wiki/images/ZSW-opening-breaking/18.png)

![](https://github.com/putianyi889/Minesweeper-makes-me-happy/blob/main/wiki/images/icons/china16.png)然而最弱破空会变成：
...
![](https://github.com/putianyi889/Minesweeper-makes-me-happy/blob/main/wiki/images/icons/china16.png)如果是良好的破空习惯：
...
![](https://github.com/putianyi889/Minesweeper-makes-me-happy/blob/main/wiki/images/icons/china16.png)仅仅下面的一个Op，无破空技术的扫雷居然用了七次点击，而顶级破空选手可以只用一次，差距可以达到一秒以上，就这么一个小Op。

# ![](https://github.com/putianyi889/Minesweeper-makes-me-happy/blob/main/wiki/images/icons/china.png)总结

![](https://github.com/putianyi889/Minesweeper-makes-me-happy/blob/main/wiki/images/icons/china16.png)破空不分扫法，即使你标雷双击可以轻易解决中腹部分，但边角位置大家都一样需要这个能力。

![](https://github.com/putianyi889/Minesweeper-makes-me-happy/blob/main/wiki/images/icons/china16.png)破空需要你具备一定的基础，如果不具备NF扫sub60的能力，还是补判雷比较好。

![](https://github.com/putianyi889/Minesweeper-makes-me-happy/blob/main/wiki/images/icons/china16.png)破空会增加操作难度，应视状态好坏而取舍。

![](https://github.com/putianyi889/Minesweeper-makes-me-happy/blob/main/wiki/images/icons/china16.png)破空对效率有着2%左右的影响，而且对NF选手影响更大，NF玩家不可或缺。

![](https://github.com/putianyi889/Minesweeper-makes-me-happy/blob/main/wiki/images/icons/china16.png)虽然写得不一定非常全面，但这些东西足够一个玩家用到sub40的水平了。