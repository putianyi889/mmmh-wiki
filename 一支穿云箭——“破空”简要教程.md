...
Although an opening (which is basically a cluster of number zeros which appear as blank cells) and the surrounding numbers within its boundary (outlined in yellow) are in one piece, you must click on a zero to finish this opening and all clicks on the boundarys are wasted.
